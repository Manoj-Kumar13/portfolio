    ...
    <section className="px-10 mb-10 pb-10">
      ...
      <div className="lg:flex gap-10">
        {skillsData.map((skill) => {
          return (
            <div className="text-center shadow-lg py-10 rounded-xl my-10  dark:bg-white flex-1">
              <Image alt="design" src={skill.image} width={100} height={100} />
              ...
              {skill.languages.map((language) => {
                return <p className="text-gray-800 py-1">{language}</p>;
              })}
            </div>
          );
        })}
